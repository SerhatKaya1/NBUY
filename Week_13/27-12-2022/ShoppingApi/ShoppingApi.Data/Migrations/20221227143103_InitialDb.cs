    ...
    public partial class InitialDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2461237b-21a1-4ba8-af06-72347d06f91a", null, "Admin rolü", "Admin", "ADMIN" },
                    { "aa1a8595-dc9d-4bc1-a92e-9af8ce0e1e1a", null, "User rolü", "User", "USER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "cf034b7f-48fa-4456-9192-50278ff6c430", 0, "Akasya cd. Orkide sk. Gül ap.", "İzmir", "62e5a4ed-3068-43c3-9132-599323c2813e", new DateTime(1985, 10, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "user@gmail.com", true, "Kemal", "Erkek", "User", false, null, "USER@GMAIL.COM", "USER", "AQAAAAIAAYagAAAAEN2d/IKqXmjJenkgh6h3x4/an3jzHed5Z6Wne8GKOdkvMBhke4PXM+6frDNA72Ku5Q==", "4444444444", false, "de65fe2e-508e-4568-a0d5-f6fc957b7afb", false, "user" },
                    { "d21feff8-84af-4a8c-95c7-5f0a1cc8b566", 0, "Çek cd. Senet sk. Fatura ap.", "İstanbul", "825013a4-781c-43ed-8a58-d6dc118f599f", new DateTime(1998, 5, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@gmail.com", true, "Deniz", "Kadın", "Admin", false, null, "ADMIN@GMAIL.COM", "ADMIN", "AQAAAAIAAYagAAAAECCSD6/drJ/720uNdFnDJ/BlMlAx9QSff89wUDU7oxw/9bdazzwji7BlVQR3LTF6vQ==", "5555555555", false, "aca68d84-40c1-4d85-8b93-d8291406d282", false, "admin" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "aa1a8595-dc9d-4bc1-a92e-9af8ce0e1e1a", "cf034b7f-48fa-4456-9192-50278ff6c430" },
                    { "2461237b-21a1-4ba8-af06-72347d06f91a", "d21feff8-84af-4a8c-95c7-5f0a1cc8b566" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "d21feff8-84af-4a8c-95c7-5f0a1cc8b566" },
                    { 2, "cf034b7f-48fa-4456-9192-50278ff6c430" }
                });
