...
app.MapControllerRoute(
    name: "products",
    pattern: "/{url?}",
    defaults: new { controller = "Shop", action = "ProductDetails" } //shop controllümün index ekþýnýný getiriyor.

    );

//http:/ localhost:5179 / Shop / ProductDetails / iphone - 13 - plus
...
app.MapControllerRoute(
    name: "default",
    pattern: "{controller=Home}/{action=Index}/{id?}"); //home controllümün index ekþýnýný getiriyor.
