...
// List<Customer> customers = context.Customers.ToList(); //Veritabanından Customersleri listele diyoruz.

// foreach (var customer in customers) //customers tablomdakileri ekrana getirme işlemi yaptım.
// {
...
//
// List<Customer> customers = context.Customers.Where(c=>c.City=="London").ToList(); //her bir customer için kontrol et.city şehire eşitse bana listele dedik.
...
//     .Where(c => c.City == "London")  //her bir city için bana city_london mu diye kontrol et diyoruz.
//     .ToList();
//her bir customer için bana yeni bir nesne yarat . Şartım her bir customer için City=London olmalıdır. 
...
/*AÇIKLAMA : Products tablosunda her bir Products için git ve kontrol et diyoruz.
 UnitPrice==minPrice
 */
