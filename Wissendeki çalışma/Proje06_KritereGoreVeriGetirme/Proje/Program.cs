...
class Program
{
    ...
    {
        Console.Clear();
        string dbName = dbType == 1 ? "MsSql" : "SqLite"; //? eğer null değilse demek.
    ...
    static void ProductsFilterByCategory(IProductDAL productDal) //Bu metot'a parametre olarak değer atıyoruz. 
    { 
