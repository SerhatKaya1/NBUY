    ...
    public class CategoryConfig : IEntityTypeConfiguration<Category>
    {
        public void Configure(EntityTypeBuilder<Category> builder)
        {
            ...
            builder.HasData(
               ...
               new Category { Id = 2 , Name= "Et Yemkleri"  , Description="Et Yemekleri bu Categoride bulunmaktadır" , Url = "Et Yemekleri"  },
               ...
               new Category { Id = 6, Name = "Salatalar",  Description = "Salatalar bu Categoride bulunmaktadır", Url = "Tatlılar" },
               new Category { Id = 7, Name = "Tatlılar",  Description = "Tatlılar bu Categoride bulunmaktadır", Url = "Tatlılar" },
