...
{
    /// <inheritdoc />
    public partial class YemekTarifiAppdb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FoodComments_Comments_CommentId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Et Yemekleri bu Categoride bulunmaktadır", "Et Yemkleri", "Et Yemekleri" },
            ...
            migrationBuilder.InsertData(
                table: "Comments",
                columns: new[] { "Id", "Confirmation", "Details", "Mail", "Name" },
                values: new object[,]
                {
                    { 1, false, "", "serhatkaya2496@gmail.com", "Serhat Kaya" },
                    { 2, false, "", "AliOnur25@gmail.com", "ALİ Onur" },
                    { 3, false, "", "r.bab96@gmail.com", "Ramazan Babayiğit" },
                    { 4, false, "", "seko94@gmail.com", "Serkan Kaya" },
                    { 5, false, "", "Aysegul86@gmail.com", "Ayşegül Karakaş" },
                    { 6, false, "", "hziyausakligil@gmail.com", "Halit Ziya Uşaklıgil" },
                    { 7, false, "", "#oseyfettin@gmail.com", "Ömer Seyfettin" },
                    { 8, false, "", "ppicasso10@gmail.com", "Pablo Picasso" },
                    { 9, false, "", "alikoc@gmail.com", "Ali Koç" },
                    { 10, false, "", "#nesrinylmz@gmail.com", "Nesrin Yılmaz" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 36, "Tüm yemeklerin yanında giden harika lezzet..", "35.Png", true, true, "200 gr. süzme yoğurt\r\n3 su bardağı su\r\n1 küçük parça tereyağı\r\n5 – 6 yaprak taze nane\r\nTuz", "Ayran ", "ayran" },
